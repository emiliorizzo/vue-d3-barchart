...
// CONCATENATED MODULE: ./src/vue-d3-barchart.vue?vue&type=template&id=3c6bd8d7&lang=pug&
...
/* harmony default export */ var vue_d3_barchartvue_type_script_lang_js_ = ({
  ...
  methods: {
    curve: function curve(opts) {
      ...
      var barw = this.barW;
      var h = this.hh;
      var offsetY = d3.min(data) - this.min;
